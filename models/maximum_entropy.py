...
class Maximum_Entropy:
    '''
    Modified maximum entropy (logistic regression) class for initial fitting and then fine tuning of weights.
    '''
    ...
    def run_sent140(self):
        ...
        '''
        # model
        self.model_sent140 = LogisticRegression(random_state=69, solver="saga", warm_start=True)
    ...
    def run_sent140_emojiless(self):
        ...
        '''
        # model
        self.model_sent140_emojiless = LogisticRegression(random_state=69, solver="saga", warm_start=True)
    ...
    def run_sent140_emoji(self):
        ...
        '''
        # model
        self.model_sent140_emoji = LogisticRegression(random_state=69, solver="saga", warm_start=True)
